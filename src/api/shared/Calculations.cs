...
public static class Calculations
{
  ...
  public static ImmutableList<GitLogRecord> IncludeName(this IEnumerable<GitLogRecord> records, string path)
  {
    return IncludeName(records, new Regex(path));
  }

  public static ImmutableList<GitLogRecord> IncludeName(this IEnumerable<GitLogRecord> records, Regex path)
  {
    return records.Where(x => path.IsMatch(x.Name)).ToImmutableList();
  }

  public static ImmutableList<GitLogRecord> ExcludeName(this IEnumerable<GitLogRecord> records, string path)
  {
    return ExcludeName(records, new Regex(path));
  }

  public static ImmutableList<GitLogRecord> ExcludeName(this IEnumerable<GitLogRecord> records, Regex path)
  {
    var excluded = records.Where(x => path.IsMatch(x.Name));
    return records.Except(excluded).ToImmutableList();
  }
